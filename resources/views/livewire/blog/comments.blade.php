        ...
        @if($totalCommentsCount > $moreComments)
            ...
            <div class="mt-8 flex justify-center">
                <button 
                    ...
                    class="inline-flex items-center px-6 py-3 border border-gray-300 shadow-sm text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200"
                >
                    <span wire:loading.remove wire:target="loadMoreComments">
                        Load {{ min(5, $totalCommentsCount - $moreComments) }} more {{ Str::plural('comment', $totalCommentsCount - $moreComments) }}
                    </span>
                    <span wire:loading wire:target="loadMoreComments" class="flex items-center gap-2">
            ...
            {{-- Infinite scroll --}}
            <div 
                wire:intersect="loadMoreComments" 
                class="mt-8 flex justify-center py-4"
            >
                <div wire:loading wire:target="loadMoreComments" class="flex items-center gap-2 text-gray-500 italic">
                    <svg class="animate-spin h-5 w-5 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
