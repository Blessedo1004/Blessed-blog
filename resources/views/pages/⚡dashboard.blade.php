...
<div>
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('home') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors duration-200">
